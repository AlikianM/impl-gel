...
def parse_cancer_htmls():
    ...
    for filename in os.listdir(report_dir_path):
        ...
        suffixes = ['v1_8.html', 'v1_9.html', 'v1_10.html']
        if filename_path.endswith(tuple(suffixes)):
            ...
            # known set of gel table titles within each html file
            ...
            # table number will vary dependant on the report content
            # and variants found. Iterate based on this.
    ...
    df_list = [participant_info_df, tumour_info_df,
            domain_1_variants_df, domain_2_variants_df, seq_quality_info_df]
